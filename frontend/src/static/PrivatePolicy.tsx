      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <section>
          ...
          <p className="text-gray-700 mb-6">
            ...
            our services. This includes personalizing your experience,
        ...
        <section>
          ...
          <p className="text-gray-700 mb-6">
            ...
            protect our rights. We may share aggregated or anonymized data that
        ...
        <section>
          ...
          <p className="text-gray-700 mb-6">
            ...
            contacting us directly. You may also opt out of receiving
