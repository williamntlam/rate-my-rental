    ...
    <div className="min-h-screen p-6 bg-gray-100">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <p className="text-gray-700 mb-6">
          Welcome to RateMyRental. By accessing and using our website, you agree
          to comply with and be bound by the following terms and conditions of
          use, which together with our privacy policy govern RateMyRental's
        ...
        <p className="text-gray-700 mb-6">
          ...
          distribute, reproduce, modify, adapt, and publicly display your
        ...
        <p className="text-gray-700 mb-6">
          ...
          laws of [Your Country/State]. Any disputes arising under or in
